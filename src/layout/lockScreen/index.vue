				...
				<div v-show="isShowLoockLogin" class="layout-lock-screen-login">
					<div class="layout-lock-screen-login-box">
						<div class="layout-lock-screen-login-box-img">
							<img
								src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg1.doubanio.com%2Fview%2Fthing_review%2Fl%2Fpublic%2Fp6346199.jpg&refer=http%3A%2F%2Fimg1.doubanio.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1636637051&t=592fe0c3088756871ed1571f8339dfa5"
							/>
						</div>
						<div class="layout-lock-screen-login-box-name">Administrator</div>
						<div class="layout-lock-screen-login-box-value">
							<el-input placeholder="请输入密码" ref="layoutLockScreenInputRef" v-model="lockScreenPassword" @keyup.enter.stop="onLockScreenSubmit()">
								<template #append>
...
export default defineComponent({
	...
	setup() {
		...
		// 时间初始化
		const initTime = () => {
			state.time.hm = dayjs().format('HH:MM');
			state.time.s = dayjs().format('SS');
			state.time.mdq = dayjs().format('mm月dd日，WWW');
		};
		// 时间初始化定时器
		const initSetTime = () => {
			initTime();
...
.layout-lock-screen-img {
	...
	background-image: url('/img/lock/03.jpg');
