...
import { getMenuAdmin, getMenuTest } from '@/model/indexRx';

const layouModules: any = require.context('../layout/routerView', true, /.vue.tsx$/);
const viewsModules: any = require.context('../views', true, /.vue.tsx$/);
/**
 * 获取目录下的 .vue、.tsx 全部文件
...
export async function getBackEndControlRoutes() {
	...
	// 管理员 admin
	if (auth === 'admin') return await getMenuAdmin().toPromise();
	// 其它用户 test
	else return await getMenuTest().toPromise();
}
