...
import { formatAxis } from 'base-core-lib-ts';
	...
	setup() {
			...
			const userInfos = {
				...
				photo:
					state.ruleForm.userName === 'admin'
						? 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg1.doubanio.com%2Fview%2Fthing_review%2Fl%2Fpublic%2Fp6346199.jpg&refer=http%3A%2F%2Fimg1.doubanio.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1636637051&t=592fe0c3088756871ed1571f8339dfa5'
		...
		const signInSuccess = () => {
			...
			setTimeout(() => {
				...
				proxy.EventBus.emit('onSignInClick');
			}, 300);
		};
		return {
			currentTime,
